  ...
  <body>
    <div id="container">
        ...
        <div id="content">
            ...
            <label for="myCheckbox2"><img src="icon\aircond.png" alt="Black Icon" width="200" height="200"><p>Airbrush</p></label>

            <input type="checkbox" id="myCheckbox3" />
            <label for="myCheckbox3"><img src="icon\battery.png" alt="Black Icon" width="200" height="200"><p>Airbrush</p></label>
            <br>
            <input type="checkbox" id="myCheckbox4" />
            <label for="myCheckbox4"><img src="icon\diagnostic.png" alt="Black Icon" width="200" height="200"><p>Airbrush</p></label>

            <input type="checkbox" id="myCheckbox5" />
            <label for="myCheckbox5"><img src="icon\engine-oil.png" alt="Black Icon" width="200" height="200"><p>Airbrush</p></label>

            <input type="checkbox" id="myCheckbox6" />
            <label for="myCheckbox6"><img src="icon\spare-tire.png" alt="Black Icon" width="200" height="200"><p>Airbrush</p></label>
        </div>
        <footer>
